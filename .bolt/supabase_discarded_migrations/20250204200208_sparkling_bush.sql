/*
  ...
  1. Changes
    - Add new freelancer profiles with realistic data
    - Add services for each freelancer
    - Add initial ratings and reviews
  
  2. Notes
    - Uses random_point_in_radius() for location generation
    - Maintains referential integrity
    - Includes realistic service rates and descriptions
*/
...
BEGIN
  ...
  FOR user_data IN (
    ...
    IF NOT EXISTS (SELECT 1 FROM auth.users WHERE id = user_data.id) THEN
      INSERT INTO auth.users (id, email)
      VALUES (user_data.id, user_data.email);
      ...
      VALUES (
        ...
        user_data.bio,
        user_data.interests,
        random_point_in_radius(-73.9851, 40.7589, 10.0),
        true,
        user_data.rating,
        true
      );
...
VALUES
  ...
  ('f1c61c3f-c6b8-4c33-b29d-c892a5c36111', 'd6c61c3f-c6b8-4c33-b29d-c892a5c36666', 5, 'Rachel''s mobile app designs are incredible. She has a great eye for detail and user experience.'),
  ('f1c61c3f-c6b8-4c33-b29d-c892a5c36111', 'd7c61c3f-c6b8-4c33-b29d-c892a5c36777', 5, 'Excellent work on our app redesign. The user research was thorough and insightful.'),

  -- Ratings for Marcus Johnson
  ('f2c61c3f-c6b8-4c33-b29d-c892a5c36222', 'd8c61c3f-c6b8-4c33-b29d-c892a5c36888', 5, 'Marcus significantly improved our ad performance. Great communication throughout the project.'),
  ('f2c61c3f-c6b8-4c33-b29d-c892a5c36222', 'd9c61c3f-c6b8-4c33-b29d-c892a5c36999', 4, 'Solid PPC campaign management with good results.'),

  -- Ratings for Isabella Garcia
  ('f3c61c3f-c6b8-4c33-b29d-c892a5c36333', 'dac61c3f-c6b8-4c33-b29d-c892a5caaa11', 5, 'Isabella''s product photos are stunning. She made our products look amazing.'),
  ('f3c61c3f-c6b8-4c33-b29d-c892a5c36333', 'd6c61c3f-c6b8-4c33-b29d-c892a5c36666', 5, 'Exceptional brand photography that perfectly captured our company culture.'),

  -- Ratings for Daniel Lee
  ('f4c61c3f-c6b8-4c33-b29d-c892a5c36444', 'd7c61c3f-c6b8-4c33-b29d-c892a5c36777', 5, 'Daniel built a robust and scalable API for our platform. Highly recommended.'),
  ('f4c61c3f-c6b8-4c33-b29d-c892a5c36444', 'd8c61c3f-c6b8-4c33-b29d-c892a5c36888', 4, 'Great work on optimizing our backend performance.'),

  -- Ratings for Sophia Patel
  ('f5c61c3f-c6b8-4c33-b29d-c892a5c36555', 'd9c61c3f-c6b8-4c33-b29d-c892a5c36999', 5, 'Sophia created beautiful animations that brought our website to life.'),
  ('f5c61c3f-c6b8-4c33-b29d-c892a5c36555', 'dac61c3f-c6b8-4c33-b29d-c892a5caaa11', 5, 'Outstanding motion graphics work. The animations perfectly matched our brand style.')
ON CONFLICT DO NOTHING;