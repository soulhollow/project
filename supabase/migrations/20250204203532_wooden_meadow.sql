/*
  # Add Stuttgart-based freelancers

  1. New Data
    - Three new freelancers based in Stuttgart
    - Services for each freelancer
    - Initial ratings and reviews
  2. Location
    - All freelancers set to Stuttgart coordinates (48.7758° N, 9.1829° E)
    - City field set to 'Stuttgart'
*/
